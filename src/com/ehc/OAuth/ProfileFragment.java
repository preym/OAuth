...
public class ProfileFragment extends Fragment {
    ...
    private class PostTweet extends AsyncTask<String, String, Status> {
        @Override
        ...
        protected twitter4j.Status doInBackground(String... args) {
            ...
            try {
                twitter4j.Status response = twitter.updateStatus(tweetText + " @keshavchinna ");
                return response;
        ...
        protected void onPostExecute(twitter4j.Status res) {
            if (res != null) {
                progress.dismiss();
